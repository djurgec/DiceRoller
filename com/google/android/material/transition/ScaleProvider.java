...
public final class ScaleProvider implements VisibilityAnimatorProvider {
  ...
  private static Animator createScaleAnimator(final View view, float paramFloat1, float paramFloat2) {
    ...
    ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(view, new PropertyValuesHolder[] { PropertyValuesHolder.ofFloat(View.SCALE_X, new float[] { f2 * paramFloat1, f2 * paramFloat2 }), PropertyValuesHolder.ofFloat(View.SCALE_Y, new float[] { f1 * paramFloat1, f1 * paramFloat2 }) });
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\com\google\android\material\transition\ScaleProvider.class

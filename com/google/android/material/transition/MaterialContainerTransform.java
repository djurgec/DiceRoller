...
public final class MaterialContainerTransform extends Transition {
  ...
  private ProgressThresholdsGroup buildThresholdsGroup(boolean paramBoolean) {
    ...
    return (pathMotion instanceof androidx.transition.ArcMotion || pathMotion instanceof MaterialArcMotion) ? getThresholdsOrDefault(paramBoolean, DEFAULT_ENTER_THRESHOLDS_ARC, DEFAULT_RETURN_THRESHOLDS_ARC) : getThresholdsOrDefault(paramBoolean, DEFAULT_ENTER_THRESHOLDS, DEFAULT_RETURN_THRESHOLDS);
  }
  ...
  public Animator createAnimator(ViewGroup paramViewGroup, TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2) {
    ...
    ShapeAppearanceModel shapeAppearanceModel2 = (ShapeAppearanceModel)paramTransitionValues1.values.get("materialContainerTransition:shapeAppearance");
    if (rectF3 == null || shapeAppearanceModel2 == null) {
      Log.w(TAG, "Skipping due to null start bounds. Ensure start view is laid out and measured.");
      return null;
    } 
    RectF rectF2 = (RectF)paramTransitionValues2.values.get("materialContainerTransition:bounds");
    ShapeAppearanceModel shapeAppearanceModel1 = (ShapeAppearanceModel)paramTransitionValues2.values.get("materialContainerTransition:shapeAppearance");
    if (rectF2 == null || shapeAppearanceModel1 == null) {
  ...
  private static final class TransitionDrawable extends Drawable {
    ...
    private TransitionDrawable(PathMotion param1PathMotion, View param1View1, RectF param1RectF1, ShapeAppearanceModel param1ShapeAppearanceModel1, float param1Float1, View param1View2, RectF param1RectF2, ShapeAppearanceModel param1ShapeAppearanceModel2, float param1Float2, int param1Int1, int param1Int2, int param1Int3, int param1Int4, boolean param1Boolean1, boolean param1Boolean2, FadeModeEvaluator param1FadeModeEvaluator, FitModeEvaluator param1FitModeEvaluator, MaterialContainerTransform.ProgressThresholdsGroup param1ProgressThresholdsGroup, boolean param1Boolean3) {
      ...
      this.containerPaint = paint5;
      Paint paint3 = new Paint();
      this.startContainerPaint = paint3;
      Paint paint4 = new Paint();
      this.endContainerPaint = paint4;
      ...
      paint5.setColor(param1Int1);
      paint3.setColor(param1Int2);
      paint4.setColor(param1Int3);
    ...
    private void updateProgress(float param1Float) {
      ...
      f3 = ((Float)Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scale.start))).floatValue();
      f4 = ((Float)Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scale.end))).floatValue();
      FitModeResult fitModeResult = this.fitModeEvaluator.evaluate(param1Float, f3, f4, this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
      this.fitModeResult = fitModeResult;
      this.currentStartBounds.set(f1 - fitModeResult.currentStartWidth / 2.0F, f2, this.fitModeResult.currentStartWidth / 2.0F + f1, this.fitModeResult.currentStartHeight + f2);
      this.currentEndBounds.set(f1 - this.fitModeResult.currentEndWidth / 2.0F, f2, this.fitModeResult.currentEndWidth / 2.0F + f1, this.fitModeResult.currentEndHeight + f2);
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\com\google\android\material\transition\MaterialContainerTransform.class

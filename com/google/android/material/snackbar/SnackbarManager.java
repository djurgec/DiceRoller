  ...
  public void show(int paramInt, Callback paramCallback) {
    synchronized (this.lock) {
      ...
      if (isNextSnackbarLocked(paramCallback)) {
        ...
        this.nextSnackbar = snackbarRecord1;
      } 
      SnackbarRecord snackbarRecord = this.currentSnackbar;
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\com\google\android\material\snackbar\SnackbarManager.class

...
public class FragmentController {
  ...
  public void attachHost(Fragment paramFragment) {
    ...
    fragmentManager.attachController(fragmentHostCallback, fragmentHostCallback, paramFragment);
  }
  ...
  public List<Fragment> retainNonConfig() {
    ...
    if (fragmentManagerNonConfig != null && fragmentManagerNonConfig.getFragments() != null) {
      ArrayList<Fragment> arrayList = new ArrayList<>(fragmentManagerNonConfig.getFragments());
    } else {
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\fragment\app\FragmentController.class

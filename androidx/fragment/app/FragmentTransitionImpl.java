    ...
    for (int i = j; i < paramList.size(); i++) {
      ...
      if (paramView instanceof ViewGroup) {
        ...
        for (byte b = 0; b < k; b++) {
          ...
          if (!containedBeforeIndex(paramList, view, j) && ViewCompat.getTransitionName(view) != null)
            paramList.add(view); 
        } 
      } 
    } 
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\fragment\app\FragmentTransitionImpl.class

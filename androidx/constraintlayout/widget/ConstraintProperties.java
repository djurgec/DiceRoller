...
public class ConstraintProperties {
  ...
  public ConstraintProperties connect(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    switch (paramInt1) {
      default:
        str2 = sideToString(paramInt1);
        str1 = sideToString(paramInt3);
        throw new IllegalArgumentException((new StringBuilder(String.valueOf(str2).length() + 12 + String.valueOf(str1).length())).append(str2).append(" to ").append(str1).append(" unknown").toString());
      case 7:
        if (paramInt3 == 7) {
    ...
    if (j != -1 || i != -1) {
      ...
      if (j != -1 && i != -1) {
        ...
        if (i != -1) {
          ...
          ConstraintLayout.LayoutParams layoutParams1 = this.mParams;
          if (i != -1)
            constraintProperties1.connect(3, layoutParams1.topToTop, 3, 0); 
        } 
      } 
    } 
    removeConstraints(3);
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\constraintlayout\widget\ConstraintProperties.class

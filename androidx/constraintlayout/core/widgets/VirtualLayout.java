...
public class VirtualLayout extends HelperWidget {
  ...
  public boolean contains(HashSet<ConstraintWidget> paramHashSet) {
    for (byte b = 0; b < this.mWidgetsCount; b++) {
      if (paramHashSet.contains(this.mWidgets[b]))
        return true; 
    } 
    return false;
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\constraintlayout\core\widgets\VirtualLayout.class

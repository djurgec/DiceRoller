...
public class Flow extends VirtualLayout {
  ...
  public void loadParameters(ConstraintSet.Constraint paramConstraint, HelperWidget paramHelperWidget, ConstraintLayout.LayoutParams paramLayoutParams, SparseArray<ConstraintWidget> paramSparseArray) {
    ...
    if (paramHelperWidget instanceof androidx.constraintlayout.core.widgets.Flow) {
      androidx.constraintlayout.core.widgets.Flow flow = (androidx.constraintlayout.core.widgets.Flow)paramHelperWidget;
  ...
  public void setLastHorizontalBias(float paramFloat) {
    this.mFlow.setLastHorizontalBias(paramFloat);
    requestLayout();
  }
  
  public void setLastHorizontalStyle(int paramInt) {
    this.mFlow.setLastHorizontalStyle(paramInt);
    requestLayout();
  }
  
  public void setLastVerticalBias(float paramFloat) {
    this.mFlow.setLastVerticalBias(paramFloat);
    requestLayout();
  }
  
  public void setLastVerticalStyle(int paramInt) {
    this.mFlow.setLastVerticalStyle(paramInt);
    requestLayout();
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\constraintlayout\helper\widget\Flow.class

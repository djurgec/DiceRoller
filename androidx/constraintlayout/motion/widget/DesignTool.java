...
public class DesignTool implements ProxyInterface {
  ...
  static {
    ...
    allAttributes = (HashMap)hashMap1;
    HashMap<Object, Object> hashMap2 = new HashMap<>();
    allMargins = (HashMap)hashMap2;
    ...
    hashMap1.put(Pair.create(integer2, integer1), "layout_constraintBottom_toTopOf");
    hashMap1.put(Pair.create(integer1, integer2), "layout_constraintTop_toBottomOf");
    hashMap1.put(Pair.create(integer1, integer1), "layout_constraintTop_toTopOf");
    ...
    hashMap1.put(Pair.create(integer1, integer1), "layout_constraintBaseline_toBaselineOf");
  ...
  private static void SetBias(ConstraintSet paramConstraintSet, View paramView, HashMap<String, String> paramHashMap, int paramInt) {
    String str2 = "layout_constraintHorizontal_bias";
    if (paramInt == 1)
  ...
  public void dumpConstraintSet(String paramString) {
    ...
    System.out.println((new StringBuilder(String.valueOf(paramString).length() + 24)).append(" dumping  ").append(paramString).append(" (").append(i).append(")").toString());
    try {
  ...
  public float getKeyFramePosition(Object paramObject, int paramInt, float paramFloat1, float paramFloat2) {
    if (!(paramObject instanceof View))
      return 0.0F; 
    paramObject = this.mMotionLayout.mFrameArrayList.get(paramObject);
    return (paramObject == null) ? 0.0F : paramObject.getKeyFrameParameter(paramInt, paramFloat1, paramFloat2);
  }
  ...
  public Boolean getPositionKeyframe(Object paramObject1, Object paramObject2, float paramFloat1, float paramFloat2, String[] paramArrayOfString, float[] paramArrayOffloat) {
    if (paramObject1 instanceof KeyPositionBase) {
      ...
      ((MotionController)this.mMotionLayout.mFrameArrayList.get(paramObject2)).positionKeyframe((View)paramObject2, (KeyPositionBase)paramObject1, paramFloat1, paramFloat2, paramArrayOfString, paramArrayOffloat);
  ...
  public boolean setKeyFramePosition(Object paramObject, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2) {
    ...
    if (this.mMotionLayout.mScene != null) {
      ...
      if (motionController != null && this.mMotionLayout.mScene.hasKeyFramePosition((View)paramObject, paramInt1)) {
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\constraintlayout\motion\widget\DesignTool.class

      ...
      if (typedValue != null) {
        ...
        if (typedValue.type != 0) {
          ...
          if (i3 > 0) {
            ...
            m = View.MeasureSpec.makeMeasureSpec(Math.min(i3 - k + m, paramInt1), 1073741824);
            k = 1;
          } 
        } 
      } 
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\ContentFrameLayout.class

  ...
  public void animateToTab(int paramInt) {
    ...
    runnable = new Runnable() {
        ...
        public void run() {
          ...
          int i = (ScrollingTabContainerView.this.getWidth() - tabView.getWidth()) / 2;
          ScrollingTabContainerView.this.smoothScrollTo(j - i, 0);
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\ScrollingTabContainerView.class

...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
  ...
  public InputConnection onCreateInputConnection(EditorInfo paramEditorInfo) {
    ...
    this.mTextHelper.populateSurroundingTextIfNeeded(this, inputConnection, paramEditorInfo);
    return AppCompatHintHelper.onCreateInputConnection(inputConnection, paramEditorInfo, (View)this);
  }
  ...
  public void setTypeface(Typeface paramTypeface, int paramInt) {
    ...
    if (paramTypeface != null) {
      typeface1 = typeface2;
      if (paramInt > 0)
        typeface1 = TypefaceCompat.create(getContext(), paramTypeface, paramInt); 
    } 
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\AppCompatTextView.class

...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
  ...
  public WindowInsets onApplyWindowInsets(WindowInsets paramWindowInsets) {
    pullChildren();
    WindowInsetsCompat windowInsetsCompat1 = WindowInsetsCompat.toWindowInsetsCompat(paramWindowInsets, (View)this);
    ...
    if (!this.mLastBaseInnerInsets.equals(windowInsetsCompat2)) {
      bool = true;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    for (paramInt1 = 0; paramInt1 < paramInt2; paramInt1++) {
      ...
      if (view.getVisibility() != 8) {
        ...
        int j = layoutParams.topMargin + paramInt3;
        view.layout(k, j, k + i, j + m);
      } 
    } 
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    i = Math.max(i + k + m, getSuggestedMinimumWidth());
    setMeasuredDimension(View.resolveSizeAndState(i, paramInt1, j), View.resolveSizeAndState(n, paramInt2, j << 16));
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\ActionBarOverlayLayout.class

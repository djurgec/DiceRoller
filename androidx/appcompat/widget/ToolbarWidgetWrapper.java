...
public class ToolbarWidgetWrapper implements DecorToolbar {
  ...
  private void setTitleInt(CharSequence paramCharSequence) {
    ...
    if ((this.mDisplayOpts & 0x8) != 0) {
      ...
      if (this.mTitleSet)
        ViewCompat.setAccessibilityPaneTitle(this.mToolbar.getRootView(), paramCharSequence); 
    } 
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\ToolbarWidgetWrapper.class

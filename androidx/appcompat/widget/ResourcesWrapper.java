...
class ResourcesWrapper extends Resources {
  ...
  public Drawable getDrawable(int paramInt, Resources.Theme paramTheme) throws Resources.NotFoundException {
    return ResourcesCompat.getDrawable(this.mResources, paramInt, paramTheme);
  }
  
  final Drawable getDrawableCanonical(int paramInt) throws Resources.NotFoundException {
    return super.getDrawable(paramInt);
  }
  
  public Drawable getDrawableForDensity(int paramInt1, int paramInt2) throws Resources.NotFoundException {
    return ResourcesCompat.getDrawableForDensity(this.mResources, paramInt1, paramInt2, null);
  }
  
  public Drawable getDrawableForDensity(int paramInt1, int paramInt2, Resources.Theme paramTheme) {
    return ResourcesCompat.getDrawableForDensity(this.mResources, paramInt1, paramInt2, paramTheme);
  }
  ...
  public void getValueForDensity(int paramInt1, int paramInt2, TypedValue paramTypedValue, boolean paramBoolean) throws Resources.NotFoundException {
    Compatibility.Api15Impl.getValueForDensity(this.mResources, paramInt1, paramInt2, paramTypedValue, paramBoolean);
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\widget\ResourcesWrapper.class

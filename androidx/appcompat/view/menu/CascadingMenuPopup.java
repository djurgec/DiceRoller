...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
  ...
  private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() {
      ...
      public void onItemHoverEnter(final MenuBuilder menu, final MenuItem item) {
        ...
        Runnable runnable = new Runnable() {
            final CascadingMenuPopup.null this$1;
  ...
  public void onDismiss() {
    CascadingMenuInfo cascadingMenuInfo1;
    CascadingMenuInfo cascadingMenuInfo2 = null;
    byte b = 0;
    int i = this.mShowingMenus.size();
    while (true) {
      cascadingMenuInfo1 = cascadingMenuInfo2;
      if (b < i) {
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\view\menu\CascadingMenuPopup.class

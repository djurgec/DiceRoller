  ...
  public boolean performItemAction(MenuItem paramMenuItem, MenuPresenter paramMenuPresenter, int paramInt) {
    ...
    if (menuItemImpl.hasCollapsibleActionView()) {
      ...
      if (menuItemImpl.hasSubMenu() || bool) {
        ...
        boolean bool3 = bool2 | dispatchSubMenuSelected(subMenuBuilder, paramMenuPresenter);
        if (!bool3)
          close(true); 
        return bool3;
      } 
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\view\menu\MenuBuilder.class

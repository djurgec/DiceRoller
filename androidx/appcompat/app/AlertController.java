...
class AlertController {
  ...
  public static class AlertParams {
    ...
    public void apply(AlertController param1AlertController) {
      ...
      if (charSequence != null || this.mPositiveButtonIcon != null)
        param1AlertController.setButton(-1, charSequence, this.mPositiveButtonListener, null, this.mPositiveButtonIcon); 
      charSequence = this.mNegativeButtonText;
      if (charSequence != null || this.mNegativeButtonIcon != null)
        param1AlertController.setButton(-2, charSequence, this.mNegativeButtonListener, null, this.mNegativeButtonIcon); 
      charSequence = this.mNeutralButtonText;
      if (charSequence != null || this.mNeutralButtonIcon != null)
        param1AlertController.setButton(-3, charSequence, this.mNeutralButtonListener, null, this.mNeutralButtonIcon); 
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\app\AlertController.class

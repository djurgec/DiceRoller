...
public class AppCompatViewInflater {
  ...
  private void backportAccessibilityAttributes(Context paramContext, View paramView, AttributeSet paramAttributeSet) {
    if (Build.VERSION.SDK_INT < 19 || Build.VERSION.SDK_INT > 28)
      return; 
    TypedArray typedArray2 = paramContext.obtainStyledAttributes(paramAttributeSet, sAccessibilityHeading);
    if (typedArray2.hasValue(0))
      ViewCompat.setAccessibilityHeading(paramView, typedArray2.getBoolean(0, false)); 
    typedArray2.recycle();
    typedArray2 = paramContext.obtainStyledAttributes(paramAttributeSet, sAccessibilityPaneTitle);
    if (typedArray2.hasValue(0))
      ViewCompat.setAccessibilityPaneTitle(paramView, typedArray2.getString(0)); 
    typedArray2.recycle();
    TypedArray typedArray1 = paramContext.obtainStyledAttributes(paramAttributeSet, sScreenReaderFocusable);
    if (typedArray1.hasValue(0))
      ViewCompat.setScreenReaderFocusable(paramView, typedArray1.getBoolean(0, false)); 
    typedArray1.recycle();
  }
    ...
    if (constructor1 == null) {
      if (paramString2 != null)
        try {
          ...
          this();
          paramString2 = stringBuilder.append(paramString2).append(paramString1).toString();
      ...
      if (-1 == str.indexOf('.')) {
        ...
        while (true) {
          ...
          if (b < arrayOfString.length) {
            View view = createViewByPrefix(paramContext, str, arrayOfString[b]);
            if (view != null)
              return view; 
            b++;
            continue;
  ...
  final View createView(View paramView, String paramString, Context paramContext, AttributeSet paramAttributeSet, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4) {
    ...
    //   797: aload #11
    //   799: aload #4
    //   801: invokespecial backportAccessibilityAttributes : (Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    //   804: aload #11
    //   806: areturn
  }
  ...
  private static class DeclaredOnClickListener implements View.OnClickListener {
    ...
    private void resolveMethod(Context param1Context) {
      ...
      if (i == -1) {
        ...
        str = " with id '" + this.mHostView.getContext().getResources().getResourceEntryName(i) + "'";
      } 
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\appcompat\app\AppCompatViewInflater.class

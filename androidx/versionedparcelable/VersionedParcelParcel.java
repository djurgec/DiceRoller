...
class VersionedParcelParcel extends VersionedParcel {
  ...
  protected VersionedParcel createSubParcel() {
    ...
    if (j == this.mOffset)
      i = this.mEnd; 
    return new VersionedParcelParcel(parcel, k, i, this.mPrefix + "  ", this.mReadCache, this.mWriteCache, this.mParcelizerCache);
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\versionedparcelable\VersionedParcelParcel.class

...
class RoundRectDrawableWithShadow extends Drawable {
  ...
  private void buildShadowCorners() {
    ...
    paint.setShader((Shader)new RadialGradient(0.0F, 0.0F, f3 + f2, new int[] { i, i, j }, new float[] { 0.0F, f1, 1.0F }, tileMode));
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\cardview\widget\RoundRectDrawableWithShadow.class

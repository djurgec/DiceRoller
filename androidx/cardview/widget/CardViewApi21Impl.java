...
class CardViewApi21Impl implements CardViewImpl {
  ...
  public void updatePadding(CardViewDelegate paramCardViewDelegate) {
    ...
    int i = (int)Math.ceil(RoundRectDrawableWithShadow.calculateHorizontalPadding(f2, f1, paramCardViewDelegate.getPreventCornerOverlap()));
    int j = (int)Math.ceil(RoundRectDrawableWithShadow.calculateVerticalPadding(f2, f1, paramCardViewDelegate.getPreventCornerOverlap()));
    paramCardViewDelegate.setShadowPadding(i, j, i, j);
  }
}


/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\cardview\widget\CardViewApi21Impl.class

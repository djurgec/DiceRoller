...
class ViewBoundsCheck {
  ...
  View findOneViewWithinBoundFlags(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    for (view = null; paramInt1 != paramInt2; view = view1) {
      View view2 = this.mCallback.getChildAt(paramInt1);
      int k = this.mCallback.getChildStart(view2);
      int m = this.mCallback.getChildEnd(view2);
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\recyclerview\widget\ViewBoundsCheck.class

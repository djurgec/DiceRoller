...
public abstract class SimpleItemAnimator extends RecyclerView.ItemAnimator {
  ...
  public boolean animateDisappearance(RecyclerView.ViewHolder paramViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo paramItemHolderInfo1, RecyclerView.ItemAnimator.ItemHolderInfo paramItemHolderInfo2) {
    int i;
    int j;
    int m = paramItemHolderInfo1.left;
    int k = paramItemHolderInfo1.top;
    ...
    if (!paramViewHolder.isRemoved() && (m != i || k != j)) {
      view.layout(i, j, view.getWidth() + i, view.getHeight() + j);
      return animateMove(paramViewHolder, m, k, i, j);
    } 
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\recyclerview\widget\SimpleItemAnimator.class

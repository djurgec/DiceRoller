...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
  ...
  private void drawVertical(Canvas paramCanvas, RecyclerView paramRecyclerView) {
    ...
    for (byte b = 0; b < j; b++) {
      ...
      int m = this.mBounds.bottom + Math.round(view.getTranslationY());
      int k = this.mDivider.getIntrinsicHeight();
      this.mDivider.setBounds(bool, m - k, i, m);
      this.mDivider.draw(paramCanvas);
    } 
    paramCanvas.restore();
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\recyclerview\widget\DividerItemDecoration.class

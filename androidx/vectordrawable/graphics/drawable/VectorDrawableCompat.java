...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    if (vPathRenderer.mViewportWidth > 0.0F) {
      if (vPathRenderer.mViewportHeight > 0.0F) {
        ...
        if (vPathRenderer.mBaseWidth > 0.0F) {
          ...
          throw new XmlPullParserException(str.getPositionDescription() + "<vector> tag requires height > 0");
        } 
        throw new XmlPullParserException(str.getPositionDescription() + "<vector> tag requires width > 0");
      } 
      throw new XmlPullParserException(str.getPositionDescription() + "<vector> tag requires viewportHeight > 0");
    } 
    throw new XmlPullParserException(str.getPositionDescription() + "<vector> tag requires viewportWidth > 0");
  }
  ...
  public float getPixelSize() {
    ...
    if (vectorDrawableCompatState == null || vectorDrawableCompatState.mVPathRenderer == null || this.mVectorState.mVPathRenderer.mBaseWidth == 0.0F || this.mVectorState.mVPathRenderer.mBaseHeight == 0.0F || this.mVectorState.mVPathRenderer.mViewportHeight == 0.0F || this.mVectorState.mVPathRenderer.mViewportWidth == 0.0F)
      return 1.0F; 
    float f3 = this.mVectorState.mVPathRenderer.mBaseWidth;
    ...
    private void drawPath(VectorDrawableCompat.VGroup param1VGroup, VectorDrawableCompat.VPath param1VPath, Canvas param1Canvas, int param1Int1, int param1Int2, ColorFilter param1ColorFilter) {
      ...
      if (param1VPath.isClipPath()) {
        ...
        if (((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathStart != 0.0F || ((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathEnd != 1.0F) {
          float f7 = ((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathStart;
          float f6 = ((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathOffset;
          ...
          path2.reset();
          if (f6 > f4) {
            this.mPathMeasure.getSegment(f6, f2, path2, true);
        ...
        if (((VectorDrawableCompat.VFullPath)param1VPath).mStrokeColor.willDraw()) {
          ...
          paint.setColorFilter((ColorFilter)path1);
          paint.setStrokeWidth(((VectorDrawableCompat.VFullPath)param1VPath).mStrokeWidth * f1 * f3);
          param1Canvas.drawPath(this.mRenderPath, paint);
        } 
      } 
    }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\vectordrawable\graphics\drawable\VectorDrawableCompat.class

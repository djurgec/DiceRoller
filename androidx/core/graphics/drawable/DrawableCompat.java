      ...
      if (Build.VERSION.SDK_INT >= 21) {
        ...
        if (paramDrawable instanceof InsetDrawable) {
          ...
          if (drawableContainerState != null) {
            ...
            while (b < i) {
              drawable = drawableContainerState.getChild(b);
              if (drawable != null)
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\graphics\drawable\DrawableCompat.class

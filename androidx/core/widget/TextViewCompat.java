...
public final class TextViewCompat {
  ...
  public static ActionMode.Callback unwrapCustomSelectionActionModeCallback(ActionMode.Callback paramCallback) {
    return (paramCallback instanceof OreoCallback && Build.VERSION.SDK_INT >= 26) ? ((OreoCallback)paramCallback).getWrappedCallback() : paramCallback;
  }
  ...
  public static ActionMode.Callback wrapCustomSelectionActionModeCallback(TextView paramTextView, ActionMode.Callback paramCallback) {
    return (Build.VERSION.SDK_INT < 26 || Build.VERSION.SDK_INT > 27 || paramCallback instanceof OreoCallback || paramCallback == null) ? paramCallback : new OreoCallback(paramCallback, paramTextView);
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\widget\TextViewCompat.class

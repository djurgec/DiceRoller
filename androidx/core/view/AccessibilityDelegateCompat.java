...
public class AccessibilityDelegateCompat {
  ...
  static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View paramView) {
    List<?> list = (List)paramView.getTag(R.id.tag_accessibility_actions);
    if (list == null)
  ...
  static final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
    ...
    public void onInitializeAccessibilityNodeInfo(View param1View, AccessibilityNodeInfo param1AccessibilityNodeInfo) {
      ...
      accessibilityNodeInfoCompat.setStateDescription(ViewCompat.getStateDescription(param1View));
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\view\AccessibilityDelegateCompat.class

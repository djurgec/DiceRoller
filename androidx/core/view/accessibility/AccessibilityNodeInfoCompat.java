...
public class AccessibilityNodeInfoCompat {
  ...
  private void removeCollectedSpans(View paramView) {
    ...
    if (sparseArray != null) {
      ...
      byte b;
      for (b = 0; b < sparseArray.size(); b++) {
        if (((WeakReference)sparseArray.valueAt(b)).get() == null)
          arrayList.add(Integer.valueOf(b)); 
      } 
      for (b = 0; b < arrayList.size(); b++)
        sparseArray.remove(((Integer)arrayList.get(b)).intValue()); 
    } 
  }
    ...
    if (Build.VERSION.SDK_INT >= 19 && Build.VERSION.SDK_INT < 26) {
      ...
      if (arrayOfClickableSpan != null && arrayOfClickableSpan.length > 0) {
        ...
        for (byte b = 0; arrayOfClickableSpan != null && b < arrayOfClickableSpan.length; b++) {
          ...
          sparseArray.put(i, new WeakReference<>(arrayOfClickableSpan[b]));
  ...
  public CharSequence getStateDescription() {
    return BuildCompat.isAtLeastR() ? this.mInfo.getStateDescription() : ((Build.VERSION.SDK_INT >= 19) ? this.mInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.STATE_DESCRIPTION_KEY") : null);
  }
  ...
  public static class AccessibilityActionCompat {
    ...
    static {
      ...
      ACTION_PRESS_AND_HOLD = new AccessibilityActionCompat(accessibilityAction1, 16908362, null, null, null);
      if (Build.VERSION.SDK_INT >= 30) {
        accessibilityAction1 = AccessibilityNodeInfo.AccessibilityAction.ACTION_IME_ENTER;
      } else {
        accessibilityAction1 = accessibilityAction2;
      } 
      ACTION_IME_ENTER = new AccessibilityActionCompat(accessibilityAction1, 16908372, null, null, null);
    }
    ...
    public boolean perform(View param1View, Bundle param1Bundle) {
      if (this.mCommand != null) {
        AccessibilityViewCommand.CommandArguments commandArguments1 = null;
        ...
        if (clazz != null) {
          commandArguments1 = commandArguments2;
          try {
            commandArguments2 = clazz.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
            commandArguments1 = commandArguments2;
            commandArguments2.setBundle(param1Bundle);
            commandArguments1 = commandArguments2;
            ...
            Log.e("A11yActionCompat", "Failed to execute command with argument class ViewCommandArgument: " + str, exception);
          } 
        } 
        return this.mCommand.perform(param1View, commandArguments1);
      } 
      return false;
    }
    
    static {
      AccessibilityNodeInfo.AccessibilityAction accessibilityAction1;
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\view\accessibility\AccessibilityNodeInfoCompat.class

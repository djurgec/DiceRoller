...
public class PrecomputedTextCompat implements Spannable {
  ...
  private PrecomputedTextCompat(PrecomputedText paramPrecomputedText, Params paramParams) {
    ...
    if (Build.VERSION.SDK_INT >= 29)
      precomputedText = paramPrecomputedText; 
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\text\PrecomputedTextCompat.class

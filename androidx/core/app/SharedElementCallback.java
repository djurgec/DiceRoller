...
public abstract class SharedElementCallback {
  ...
  private static Bitmap createDrawableBitmap(Drawable paramDrawable) {
    ...
    i = (int)(i * f);
    int n = (int)(j * f);
    Bitmap bitmap = Bitmap.createBitmap(i, n, Bitmap.Config.ARGB_8888);
    ...
    j = rect.right;
    int i1 = rect.bottom;
    paramDrawable.setBounds(0, 0, i, n);
    paramDrawable.draw(canvas);
    paramDrawable.setBounds(k, m, j, i1);
    return bitmap;
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\app\SharedElementCallback.class

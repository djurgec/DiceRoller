...
public abstract class JobIntentService extends Service {
  ...
  static WorkEnqueuer getWorkEnqueuer(Context paramContext, ComponentName paramComponentName, boolean paramBoolean, int paramInt) {
    ...
    WorkEnqueuer workEnqueuer2 = hashMap.get(paramComponentName);
  ...
  void processorFinished() {
    ...
    //   44: ifne -> 54
    //   47: aload_0
    //   48: getfield mCompatWorkEnqueuer : Landroidx/core/app/JobIntentService$WorkEnqueuer;
  ...
  static final class CompatWorkEnqueuer extends WorkEnqueuer {
    ...
    CompatWorkEnqueuer(Context param1Context, ComponentName param1ComponentName) {
      ...
      PowerManager.WakeLock wakeLock2 = powerManager.newWakeLock(1, param1ComponentName.getClassName() + ":launch");
      this.mLaunchWakeLock = wakeLock2;
      wakeLock2.setReferenceCounted(false);
      PowerManager.WakeLock wakeLock1 = powerManager.newWakeLock(1, param1ComponentName.getClassName() + ":run");
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\app\JobIntentService.class

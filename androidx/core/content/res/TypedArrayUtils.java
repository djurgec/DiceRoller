...
public class TypedArrayUtils {
  ...
  public static ColorStateList getNamedColorStateList(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser, Resources.Theme paramTheme, String paramString, int paramInt) {
    if (hasAttribute(paramXmlPullParser, paramString)) {
      ...
      throw new UnsupportedOperationException("Failed to resolve attribute at index " + paramInt + ": " + typedValue);
    } 
    return null;
  }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\content\res\TypedArrayUtils.class

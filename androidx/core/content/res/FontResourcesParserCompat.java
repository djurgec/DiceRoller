...
public class FontResourcesParserCompat {
  ...
  private static FamilyResourceEntry readFamily(XmlPullParser paramXmlPullParser, Resources paramResources) throws XmlPullParserException, IOException {
    ...
    String str4 = typedArray.getString(R.styleable.FontFamily_fontProviderPackage);
    ...
    String str2 = typedArray.getString(R.styleable.FontFamily_fontProviderSystemFontFamily);
    typedArray.recycle();
    if (str1 != null && str4 != null && str3 != null) {
      while (paramXmlPullParser.next() != 3)
        skip(paramXmlPullParser); 
      return new ProviderResourceEntry(new FontRequest(str1, str4, str3, readCerts(paramResources, i)), j, k, str2);
    } 
  ...
  public static final class ProviderResourceEntry implements FamilyResourceEntry {
    ...
    public ProviderResourceEntry(FontRequest param1FontRequest, int param1Int1, int param1Int2) {
      this(param1FontRequest, param1Int1, param1Int2, null);
    }
    
    public ProviderResourceEntry(FontRequest param1FontRequest, int param1Int1, int param1Int2, String param1String) {
      this.mRequest = param1FontRequest;
      this.mStrategy = param1Int1;
      this.mTimeoutMs = param1Int2;
      this.mSystemFontFamilyName = param1String;
    }
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\core\content\res\FontResourcesParserCompat.class

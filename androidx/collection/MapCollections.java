  ...
  final class EntrySet implements Set<Map.Entry<K, V>> {
    ...
    public int hashCode() {
      ...
      for (int i = MapCollections.this.colGetSize() - 1; i >= 0; i--) {
        ...
        Object object1 = MapCollections.this.colGetEntry(i, 1);
        if (object2 == null) {
          k = 0;
        } else {
          k = object2.hashCode();
...
/* Location:              C:\Users\dario\OneDrive\Desktop\dex-tools-v2.4\dex-tools-v2.4\classes-dex2jar.jar!\androidx\collection\MapCollections.class
